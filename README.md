...
## [6월 3일]
 ...
 ● 포스터 디자인을 기존에 있던 디자인말고 새로운 디자인을 만들어서 기존에 만들었던 디자인 초안과 새로운 디자인 도안을 비교해서 더 좋은 디자인을 쓰기로 결정했습니다
 
 ● 사이트가 완성되어서 XD작업을 최대한 가능한 부분까지 할 예정입니다
...
## [5월 26일]
 ...
 ● 교수님이 말씀하셨던 조건으로 제 사이트 포스터를 A1 B4 크기에 맞추어 기본 틀을 만들었습니다. 추후에 다른 포스터 디자인들을 참고하여 더 좋은 디자인을 바꿀예정입니다
 
 ● 기존 XD 작업을 메인 페이지랑 나라별원두 페이지, 홈카페 라이브까지 완성한 상태여서 사이트가 더 완성되면 XD 작업을 추후에 끝낼 예정이다
...
## [5월 18일]
 ...
 ● 기존에 양식만 만들었던 페이지 디자인을 '재선택', '조합하기' 버튼 부분들을 같은 열에 배치하고 footer 부분에 숨겨놓았던 원듀 선택을 폴더 혹은 봉투 이미지를 사용하여 자연스러운 디    자인을 만들었습니다 
 
 ● 기존에 작업하던 XD작업을 기존에 사용했던 디자인들을 지우고 새로운 디자인로 대체하여 작업은 이어갈 예정입니다
 
 ● 포스터는 여러 다른 사람들의 포스터를 통하여 나중에 재차 디자인 요소들을 가지고 와서 재회의하기로 결정했습니다.
...
## [5월 13일]
 ...
 ● 나라별 원두 슬라이드는 나라별이라는 점을 살리기 위하여 세계지도를 넣어서 그 부분을 살렸습니다 그리고 저희가 선정한 나라들의 국기들을 같이 넣어서 새롭게 만들었습니다
 
 ● 커피 효능 부분은 기존에 있던 배경을 없애고 색으로 배경을 삼았고 커피잔에 저희 로고을 넣었고 날씨가 요즘 더워져서 아이스 커피로 했습니다.
 
 ● 나라별 원두 페이지에서는 마커로 세계지도에 나라별 위치들을 표시하고 마커만 표시하면 나라들을 잘 모를 수 있기 때문에 마커 위에 나라별 국기까지 추가하여 알아보기 쉽게 했습니다
 
 ● 올바웃 슬라이드 부분은 기존에 있던 부분과 이질감이 느껴서 새롭게 만들었습니다. 한쪽에 커피와 원두들을 배열하였고 다른 쪽은 버튼을 배열하기 위해서 비워놓게 디자인을 

![커피의-효능](https://user-images.githubusercontent.com/79886533/168433624-05ae78f5-d585-4ec9-822d-1614a2760ae1.png)
![나라별-원두](https://user-images.githubusercontent.com/79886533/168433690-928950db-0330-430f-919a-e69f38885b70.png)
![올바웃부누](https://user-images.githubusercontent.com/79886533/168433752-0977f256-506a-43df-b215-3ca9f0af587d.png)
...
## [5월 4일]
 ...
 ● 저번 회의 때 사용했던 디자인말고 커피 효능 슬라이드 부분을 새로 디자인을 도안하여 제작하기로 했습니다. 
 
 ● 블렌딩 시스템을 어떤 디자인을 만들고 어떻게 배치 할지 등의 내용들을 회의했고 다른 사이트들을 밴치마킹하였습니다
 
 ● 메인 페이지를 xd 작업을 하여 메인페이지를 만들어서 어떤지 확인을 해보니 이상한 디자인 요소들이 발생하여 새롭게 다시 디자인을 하기로 했습니다. 그래서 바꾸기로 한 요소들은 나라별 유형, 커피 효능, 블렌딩 시스템 위치 등을 부분들을 어떯게 할지 회의
